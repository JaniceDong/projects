window.onload = function () {
   ...
   function pullDownData(){
       $.ajax({
           url:'http://localhost/1609/day--1027/zxiu/zxiu.php',
           //url:"http:zxiu.php",
           dataType:"json",//不写数据类型，默认为字符串类型
           success: function (data) {
               data.forEach(function (v,k){
                    oPullData.prepend('<li><p class="left"><a href="javascript:;"><img src="'+ v.url+'" alt="28880土耳其世纪玫瑰浪漫之旅"></a></p><div class="right"><p>'+ v.title+'</p><p><span class="iconfont price">'+ v.price+'</span><span class="discount"><del>'+ v.discountprice+'</del></span></p><span>'+ v.discount+'</span><p class="cart"><span class="iconfont">&#xe685;</span></p></div></li>');
               });
               //console.log(data);
               oScroll.refresh();
           }
    ...
    function pullUpData(){
        $.ajax({
            ...
            success: function (data) {
                data.forEach(function (v,k){
                    oPullData.append('<li><p class="left"><a href="javascript:;"><img src="'+ v.url+'" alt="28880土耳其世纪玫瑰浪漫之旅"></a></p><div class="right"><p>'+ v.title+'</p><p><span class="iconfont price">'+ v.price+'</span><span class="discount"><del>'+ v.discountprice+'</del></span></p><span>'+ v.discount+'</span><p class="cart"><span class="iconfont">&#xe685;</span></p></div></li>');
                });
                 console.log(data);
                oScroll.refresh();
            }
